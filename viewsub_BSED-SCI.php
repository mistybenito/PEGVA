            ...
            <div id ="one-one">
                        <div id ="oneone0" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_s/first_year/first_sem/subject1'; //HERE
...
<?//boundary/////////////////////////////////////////////////////////////////////////////////////////////////////////////?>
                        ...
                        <div id ="oneone1" class = "hidden">
                            <table>
                                    ...
                                    <?php 
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_s/first_year/first_sem/subject2'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
            ...
            <div id ="one-two">
                        <div id ="onetwo0" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_s/first_year/second_sem/subject1'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
...
<?//boundary/////////////////////////////////////////////////////////////////////////////////////////////////////////////?>
                        ...
                        <div id ="onetwo1" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_s/first_year/second_sem/subject2'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="onetwo2" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_s/first_year/second_sem/subject3'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="onetwo3" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_s/first_year/second_sem/subject4'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="onetwo4" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_s/first_year/second_sem/subject5'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="onetwo5" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_s/first_year/second_sem/subject6'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="onetwo6" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_s/first_year/second_sem/subject7'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="onetwo7" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_s/first_year/second_sem/subject8'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="onetwo8" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_s/first_year/second_sem/subject9'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
            ...
            <div id ="two-one">
                    <div id ="twoone0" class = "hidden">
                        <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_s/second_year/first_sem/subject1'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
...
<?//boundary/////////////////////////////////////////////////////////////////////////////////////////////////////////////?>
                        ...
                        <div id ="twoone1" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_s/second_year/first_sem/subject2'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="twoone2" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_s/second_year/first_sem/subject3'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="twoone3" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_s/second_year/first_sem/subject4'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="twoone4" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_s/second_year/first_sem/subject5'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="twoone5" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_s/second_year/first_sem/subject6'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="twoone6" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_s/second_year/first_sem/subject7'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="twoone7" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_s/second_year/first_sem/subject8'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="twoone8" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_s/second_year/first_sem/subject9'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
            ...
            <div id ="two-two">
                    <div id ="twotwo0" class = "hidden">
                        <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_s/second_year/second_sem/subject1'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
...
<?//boundary/////////////////////////////////////////////////////////////////////////////////////////////////////////////?>
                        ...
                        <div id ="twotwo1" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_s/second_year/second_sem/subject2'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="twotwo2" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_s/second_year/second_sem/subject3'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="twotwo3" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_s/second_year/second_sem/subject4'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="twotwo4" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_s/second_year/second_sem/subject5'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="twotwo5" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_s/second_year/second_sem/subject6'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="twotwo6" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_s/second_year/second_sem/subject7'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="twotwo7" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_s/second_year/second_sem/subject8'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="twotwo8" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_s/second_year/second_sem/subject9'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
            ...
            <div id ="three-one">
                    <div id ="threeone0" class = "hidden">
                        <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_s/third_year/first_sem/subject1'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
...
<?//boundary/////////////////////////////////////////////////////////////////////////////////////////////////////////////?>
                        ...
                        <div id ="threeone1" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_s/third_year/first_sem/subject2'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="threeone2" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_s/third_year/first_sem/subject3'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="threeone3" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_s/third_year/first_sem/subject4'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="threeone4" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_s/third_year/first_sem/subject5'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="threeone5" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_s/third_year/first_sem/subject6'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="threeone6" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_s/third_year/first_sem/subject7'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
            ...
            <div id ="three-two">
                    <div id ="threetwo0" class = "hidden">
                        <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_s/third_year/second_sem/subject1'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
...
<?//boundary/////////////////////////////////////////////////////////////////////////////////////////////////////////////?>
                        ...
                        <div id ="threetwo1" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_s/third_year/second_sem/subject2'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="threetwo2" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_s/third_year/second_sem/subject3'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="threetwo3" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_s/third_year/second_sem/subject4'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="threetwo4" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_s/third_year/second_sem/subject5'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="threetwo5" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_s/third_year/second_sem/subject6'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="threetwo6" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_s/third_year/second_sem/subject7'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
            ...
            <div id ="four-one">
                    <div id ="fourone0" class = "hidden">
                        <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_s/fourth_year/first_sem/subject1'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
...
<?//boundary/////////////////////////////////////////////////////////////////////////////////////////////////////////////?>
                        ...
                        <div id ="fourone1" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_s/fourth_year/first_sem/subject2'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="fourone2" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_s/fourth_year/first_sem/subject3'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="fourone3" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_s/fourth_year/first_sem/subject4'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="fourone4" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_s/fourth_year/first_sem/subject5'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
            ...
            <div id ="four-two">
                    <div id ="fourtwo0" class = "hidden">
                        <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_s/fourth_year/second_sem/subject1'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
