...
<div id="npup1" class="hidden">
      <h3>BEED 1st Year, Second Sem</h3>
      <form name="form1" method="post" action="code.php">	   
	<center>
	<table>
		<tr> 
		...
		<tr>
			...
			<td><?=$row['units']; ?></td>
			<td>
                <a href="editcurric.php?id=beed/first_year/second_sem/<?=$key;?>&course=BEED" class = "btn btn btn-primary" id="btnView"> View </a>
            </td>
		</tr>
			<?php
				}
	...
	<table>
		...
		<tr>
			...
			<td><?=$row['units']; ?></td>
			<td>
                <a href="editcurric.php?id=beed/second_year/first_sem/<?=$key;?>&course=BEED" class = "btn btn btn-primary" id="btnView"> View </a>
            </td>
		</tr>
			<?php
				}
	...
	<div id="npup3" class="hidden">
      <h3>BEED 2nd Year, Second Sem</h3>
      <form name="form1" method="post" action="code.php">	   
<center>
	<table>
			<tr> 
...
<center>
	<table>
		...
		<tr>
			...
			<td><?=$row['units']; ?></td>
			<td>
                <a href="editcurric.php?id=beed/third_year/first_sem/<?=$key;?>&course=BEED" class = "btn btn btn-primary" id="btnView"> View </a>
            </td>
		</tr>
			<?php
				}
...
<div id="btns">
	...
	<div id="npup5" class="hidden">
      <h3>BEED 3rd Year, Second Sem</h3>
      <form name="form1" method="post" action="code.php">	   
<center>
	<table>
			<tr> 
		...
		<tr>
			...
			<td><?=$row['units']; ?></td>
			<td>
                <a href="editcurric.php?id=beed/third_year/second_sem/<?=$key;?>&course=BEED" class = "btn btn btn-primary" id="btnView"> View </a>
            </td>
		</tr>
			<?php
				}
...
<center>
	<table>
		...
		<tr>
			...
			<td><?=$row['units']; ?></td>
			<td>
                <a href="editcurric.php?id=beed/fourth_year/first_sem/<?=$key;?>&course=BEED" class = "btn btn btn-primary" id="btnView"> View </a>
            </td>
		</tr>
			<?php
				}
...
<div id="btns">
	...
	<div id="npup7" class="hidden">
      <h3>BEED 4th Year, Second Sem</h3>
      <form name="form1" method="post" action="code.php">	   
<center>
	<table>
			<tr> 
		...
		<tr>
			...
			<td><?=$row['units']; ?></td>
			<td>
                <a href="editcurric.php?id=beed/fourth_year/second_sem/<?=$key;?>&course=BEED" class = "btn btn btn-primary" id="btnView"> View </a>
            </td>
		</tr>
			<?php
				}
