            ...
            <div id ="one-one">
                        <div id ="oneone0" class = "hidden">
                            <table>
                                   ...
                                   $ref_table = 'Subjects/BSED_M/first_year/first_sem/'.$scode;
                                    ...
                                    ?>
                                            ...
                                            if ($row['Grade'] == '0') {
                                                    ?>
                                                        ...
                                                        <td> N/A </td>
                                                         <td> 
                                                        <a href="addgrades/BSED_M_addgrades.php?id=<?= $key_child; ?>&Subject_code=<?= $scode; ?>&ref=<?= $reference; ?>&sub=<?= $ref_table; ?>&where=<?= $sub_table;?>&student=<?=$sname;?>&snumber=<?=$snumb;?>" class = "btn btn btn-primary" style="color=black"> Add </a>
                                                        </td>
                                                        <td> N/A </td>
                                                    </tr>
                                                    <?php
                                                ...
                                                elseif ($row['grade01'] > "3.0") 
                                                {
                                                            ...
                                                            ?>
                                                        <td> 
                                                        <a href="addgrades/BSED_M_addgrades.php?id=<?= $key_child; ?>&Subject_code=<?= $scode; ?>&ref=<?= $reference; ?>&sub=<?= $ref_table; ?>&where=<?= $sub_table;?>&student=<?=$sname;?>&snumber=<?=$snumb;?>" class = "btn btn btn-primary" style="color=black"> Edit </a>
                                                        </td>
                                                        <td> Delete </td>
...
<?//boundary/////////////////////////////////////////////////////////////////////////////////////////////////////////////?>
                        ...
                        <div id ="oneone2" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_m/first_year/first_sem/subject03'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="oneone3" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_m/first_year/first_sem/subject04'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="oneone4" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_m/first_year/first_sem/subject05'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="oneone5" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_m/first_year/first_sem/subject06'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="oneone6" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_m/first_year/first_sem/subject07'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="oneone7" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_m/first_year/first_sem/subject08'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="oneone8" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_m/first_year/first_sem/subject09'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="oneone9" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_m/first_year/first_sem/subject10'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
            ...
            <div id ="one-two">
                        <div id ="onetwo0" class = "hidden">
                            <table>
                                    ...
                                    $ref_table = 'Subjects/BSED_M/first_year/second_sem/'.$scode;
                        ...
                        <table>
                                    ...
                                    if ($fetch > 0) {
                                        ...
                                        <?php
                                               ...
                                               $ref_table = 'Subjects/BSED_M/second_year/first_sem/'.$scode;
                        ...
                        <table>
                                    ...
                                    if ($fetch > 0) {
                                        ...
                                        <?php
                                              ...
                                              $ref_table = 'Subjects/BSED_M/second_year/second_sem/'.$scode;
                                    ...
                                    $sub_table = 'second_year/second_sem';
                                            ...
                                            if ($row['Grade'] == '0') {
                                                    ?>
                                                        <td> No Grades yet.</td>
                                                        <td> N/A </td>
                                                         <td> <a href="addgrades/BSED_M_addgrades.php?id=<?= $key_child; ?>&Subject_code=<?= $scode; ?>&ref=<?= $reference; ?>&sub=<?= $ref_table; ?>&where=<?= $sub_table;?>&student=<?=$sname;?>&snumber=<?=$snumb;?>" class = "btn btn btn-primary" style="color=black"> Add </a><a href="addgrades/22_addgrades_REED221.php?id=<?= $key_child; ?>" class = "btn btn btn-primary" style="color=black"> Add </a>
                                                        </td>
                                                    </tr>
                                                    <?php
                                            } else {
                        ...
                        <table>
                                    ...
                                    if ($fetch > 0) {
                                        ...
                                        <?php
                                               ...
                                               $ref_table = 'Subjects/BSED_M/third_year/first_sem/'.$scode;
...
<?//boundary/////////////////////////////////////////////////////////////////////////////////////////////////////////////?>
                        ...
                        <div id ="threeone7" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_m/third_year/first_sem/subject08'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="threeone8" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_m/third_year/first_sem/subject09'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="threeone9" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_m/third_year/first_sem/subject10'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <table>
                                    ...
                                    if ($fetch > 0) {
                                        ...
                                        <?php
                                               ...
                                               $ref_table = 'Subjects/BSED_M/third_year/second_sem/'.$scode;
...
<?//boundary/////////////////////////////////////////////////////////////////////////////////////////////////////////////?>
                        ...
                        <div id ="threetwo7" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_m/third_year/second_sem/subject08'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="threetwo8" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_m/third_year/second_sem/subject09'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="threetwo9" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsed_m/third_year/second_sem/subject10'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
            ...
            <div id ="four-one">
                    <div id ="fourone0" class = "hidden">
                        <table>
                                    ...
                                    $ref_table = 'Subjects/BSED_M/fourth_year/first_sem/'.$scode;
                        ...
                        <table>
                                    ...
                                    if ($fetch > 0) {
                                        ...
                                        <?php
                                               ...
                                               $ref_table = 'Subjects/BSED_M/fourth_year/second_sem/'.$scode;
