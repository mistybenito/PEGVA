	...
	if(isset($_GET['id']))
	{
		...
		if($getdata > 0)
		{
			...
			<input type="hidden" name= "id" value="<?=$key_child;?>">
				...
				<input type="text" name="Subject_code" value = "GE100" class="form-control">
				</div>

				<div class="form-group mb-3">
				<label for="">Description Title</label>
				<input type="text" name="Desc_title" value = "Understanding the Self" class="form-control">
				</div>
				...
				<div class="form-group mb-3">
				<button type="submit" name="add_grades_ge100" class="btn btn-primary"> Save Contact </button>
				</div>
						</table> 
					</form>
					<?php
