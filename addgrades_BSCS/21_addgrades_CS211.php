...
<div id="subject_info">
	...
	if(isset($_GET['id']))
	{
		...
		<tr> 
			<td>Subject Code</td>
			<td><input type="text" name = "Subject_code" value = "CS211"></td>
		</tr>
		<tr> 
			<td>Descriptive Title</td>
			<td><input type="text" name = "Desc_title" value ="Object-oriented Programming 1" ></td>
		</tr>
        <tr> 
			<td>Unit</td>
		...
		<center><button type="submit" name = "add_grades_cs211" id="update"> Save </button></center>
	</form>
	<?php
						}
						else
