	...
	if(isset($_GET['id']))
	{
		...
		if($getdata > 0)
		{
			...
			<input type="hidden" name= "id" value="<?=$key_child;?>">
				...
				<input type="text" name="Subject_code" value = "CS112" class="form-control">
				</div>

				<div class="form-group mb-3">
				<label for="">Description Title</label>
				<input type="text" name="Desc_title" value = "Computer Programming 1" class="form-control">
				</div>
				...
				<div class="form-group mb-3">
				<button type="submit" name="add_grades_cs112" class="btn btn-primary"> Save Contact </button>
				</div>
						</table> 
					</form>
					<?php
