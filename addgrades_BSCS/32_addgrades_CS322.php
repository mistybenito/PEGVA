...
<div id="subject_info">
	...
	if(isset($_GET['id']))
	{
		...
		<tr> 
			<td>Subject Code</td>
			<td><input type="text" name = "Subject_code" value = "CS322"></td>
		</tr>
		<tr> 
			<td>Descriptive Title</td>
			<td><input type="text" name = "Desc_title" value ="Software Engineering" ></td>
		</tr>
        <tr> 
			<td>Unit</td>
		...
		<center><button type="submit" name = "add_grades_cs322" id="update"> Save </button></center>
	</form>
	<?php
						}
						else
