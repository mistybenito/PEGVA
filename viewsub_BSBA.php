            ...
            <div id ="one-one">
                        <div id ="oneone0" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/first_year/first_sem/subject01'; //HERE
                                    ...
                                    ?>
                                            ...
                                            if ($row['Grade'] == '0') {
                                                    ?>
                                                        ...
                                                        <td> N/A </td>
                                                         <td> 
                                                        <a href="addgrades/BSBA_addgrades.php?id=<?= $key_child; ?>&Subject_code=<?= $scode; ?>&ref=<?= $reference; ?>&sub=<?= $ref_table; ?>&where=<?= $sub_table;?>&student=<?=$sname;?>&snumber=<?=$snumb;?>" class = "btn btn btn-primary" style="color=black"> Add </a>
                                                        </td>
                                                        <td> N/A </td>
                                                    </tr>
                                                    <?php
                                                ...
                                                elseif ($row['grade01'] > "3.0") 
                                                {
                                                            ...
                                                            ?>
                                                        <td> 
                                                        <a href="addgrades/BSBA_addgrades.php?id=<?= $key_child; ?>&Subject_code=<?= $scode; ?>&ref=<?= $reference; ?>&sub=<?= $ref_table; ?>&where=<?= $sub_table;?>&student=<?=$sname;?>&snumber=<?=$snumb;?>" class = "btn btn btn-primary" style="color=black"> Edit </a>
                                                        </td>
                                                        <td> Delete </td>
...
<?//boundary/////////////////////////////////////////////////////////////////////////////////////////////////////////////?>
                        ...
                        <div id ="oneone1" class = "hidden">
                            <table>
                                    ...
                                    <?php 
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/first_year/first_sem/subject02'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="oneone2" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/first_year/first_sem/subject03'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="oneone3" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/first_year/first_sem/subject04'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="oneone4" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/first_year/first_sem/subject05'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="oneone5" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/first_year/first_sem/subject06'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="oneone6" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/first_year/first_sem/subject07'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="oneone7" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/first_year/first_sem/subject08'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="oneone8" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/first_year/first_sem/subject09'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="oneone9" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/first_year/first_sem/subject10'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
            ...
            <div id ="one-two">
                        <div id ="onetwo0" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/first_year/second_sem/subject01'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
...
<?//boundary/////////////////////////////////////////////////////////////////////////////////////////////////////////////?>
                        ...
                        <div id ="onetwo1" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/first_year/second_sem/subject02'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="onetwo2" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/first_year/second_sem/subject03'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="onetwo3" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/first_year/second_sem/subject04'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="onetwo4" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/first_year/second_sem/subject05'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="onetwo5" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/first_year/second_sem/subject06'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="onetwo6" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/first_year/second_sem/subject07'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="onetwo7" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/first_year/second_sem/subject08'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="onetwo8" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/first_year/second_sem/subject09'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
            ...
            <div id ="two-one">
                    <div id ="twoone0" class = "hidden">
                        <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/second_year/first_sem/subject01'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
...
<?//boundary/////////////////////////////////////////////////////////////////////////////////////////////////////////////?>
                        ...
                        <div id ="twoone1" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/second_year/first_sem/subject02'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="twoone2" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/second_year/first_sem/subject03'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="twoone3" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/second_year/first_sem/subject04'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="twoone4" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/second_year/first_sem/subject05'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="twoone5" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/second_year/first_sem/subject06'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="twoone6" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/second_year/first_sem/subject07'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="twoone7" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/second_year/first_sem/subject08'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="twoone8" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/second_year/first_sem/subject09'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
            ...
            <div id ="two-two">
                    <div id ="twotwo0" class = "hidden">
                        <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/second_year/second_sem/subject01'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
...
<?//boundary/////////////////////////////////////////////////////////////////////////////////////////////////////////////?>
                        ...
                        <div id ="twotwo1" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/second_year/second_sem/subject02'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="twotwo2" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/second_year/second_sem/subject03'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="twotwo3" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/second_year/second_sem/subject04'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="twotwo4" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/second_year/second_sem/subject05'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="twotwo5" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/second_year/second_sem/subject06'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="twotwo6" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/second_year/second_sem/subject07'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="twotwo7" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/second_year/second_sem/subject08'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="twotwo8" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/second_year/second_sem/subject09'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                                    ...
                                    $sub_table = 'second_year/second_sem';
                                            ...
                                            if ($row['Grade'] == '0') {
                                                    ?>
                                                        <td> No Grades yet.</td>
                                                        <td> N/A </td>
                                                         <td> <a href="addgrades/BSBA_addgrades.php?id=<?= $key_child; ?>&Subject_code=<?= $scode; ?>&ref=<?= $reference; ?>&sub=<?= $ref_table; ?>&where=<?= $sub_table;?>&student=<?=$sname;?>&snumber=<?=$snumb;?>" class = "btn btn btn-primary" style="color=black"> Add </a><a href="addgrades/22_addgrades_REED221.php?id=<?= $key_child; ?>" class = "btn btn btn-primary" style="color=black"> Add </a>
                                                        </td>
                                                    </tr>
                                                    <?php
                                            } else {
            ...
            <div id ="three-one">
                    <div id ="threeone0" class = "hidden">
                        <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/third_year/first_sem/subject01'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
...
<?//boundary/////////////////////////////////////////////////////////////////////////////////////////////////////////////?>
                        ...
                        <div id ="threeone1" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/third_year/first_sem/subject02'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="threeone2" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/third_year/first_sem/subject03'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="threeone3" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/third_year/first_sem/subject04'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="threeone4" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/third_year/first_sem/subject05'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="threeone5" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/third_year/first_sem/subject06'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="threeone6" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/third_year/first_sem/subject07'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="threeone7" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/third_year/first_sem/subject08'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="threeone8" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/third_year/first_sem/subject09'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="threeone9" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/third_year/first_sem/subject10'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
            ...
            <div id ="three-two">
                    <div id ="threetwo0" class = "hidden">
                        <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/third_year/second_sem/subject01'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
...
<?//boundary/////////////////////////////////////////////////////////////////////////////////////////////////////////////?>
                        ...
                        <div id ="threetwo1" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/third_year/second_sem/subject02'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="threetwo2" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/third_year/second_sem/subject03'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="threetwo3" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/third_year/second_sem/subject04'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="threetwo4" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/third_year/second_sem/subject05'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="threetwo5" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/third_year/second_sem/subject06'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="threetwo6" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/third_year/second_sem/subject07'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="threetwo7" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/third_year/second_sem/subject08'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="threetwo8" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/third_year/second_sem/subject09'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="threetwo9" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/third_year/second_sem/subject10'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
            ...
            <div id ="four-one">
                    <div id ="fourone0" class = "hidden">
                        <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/fourth_year/first_sem/subject01'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
...
<?//boundary/////////////////////////////////////////////////////////////////////////////////////////////////////////////?>
                        ...
                        <div id ="fourone1" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/fourth_year/first_sem/subject02'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="fourone2" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/fourth_year/first_sem/subject03'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="fourone3" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/fourth_year/first_sem/subject04'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
                        ...
                        <div id ="fourone4" class = "hidden">
                            <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/fourth_year/first_sem/subject05'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
            ...
            <div id ="four-two">
                    <div id ="fourtwo0" class = "hidden">
                        <table>
                                    ...
                                    <?php
                                    include('dbcon.php');
                                    $reference = 'course_curriculum/bsba/fourth_year/second_sem/subject01'; //HERE
                                    $fetch = $database->getReference($reference)->getValue();
                                    if ($fetch > 0) {
                                        ?>
                                        <input type="text" name = "Subject_code" value ="<?=$scode = $fetch['code'] ?>">
