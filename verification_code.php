...
if (isset($_POST['yes_verify'])) {
    ...
    if ($fetch > 0) {
        ...
        foreach ($fetch as $key_child => $row) {
            ...
            $CSsubject = $row['code'];
            $ref_table = 'User/' . $key;
            $oneone = 'Subjects/ABREED/first_year/first_sem/' . $CSsubject . '/' . $key;
            $updatequery_result = $database->getReference($ref_table)->update($updateData);
            $addsub = $database->getReference($oneone)->update($studentData);
                if ($updatequery_result) {
                    $_SESSION['status'] = "Contact Verified Successfully";
    ...
    elseif ($year == "First Year" && $sem == "Second" && $course == "Bachelor of Arts in Religious Education") 
    {
        ...
        if ($fetch > 0) {
            ...
            foreach ($fetch as $key_child => $row) {
                ...
                $CSsubject = $row['code'];
                $ref_table = 'User/' . $key;
                $oneone = 'Subjects/ABREED/first_year/second_sem/' . $CSsubject . '/' . $key;
                $updatequery_result = $database->getReference($ref_table)->update($updateData);
                $addsub = $database->getReference($oneone)->update($studentData);
                    if ($updatequery_result) {
                        $_SESSION['status'] = "Contact Verified Successfully";
        ...
        elseif ($year == "Second Year" && $sem == "First" && $course == "Bachelor of Arts in Religious Education") 
    {
        ...
        if ($fetch > 0) {
            ...
            foreach ($fetch as $key_child => $row) {
                ...
                $CSsubject = $row['code'];
                $ref_table = 'User/' . $key;
                $oneone = 'Subjects/ABREED/second_year/first_sem/' . $CSsubject . '/' . $key;
                $updatequery_result = $database->getReference($ref_table)->update($updateData);
                $addsub = $database->getReference($oneone)->update($studentData);
                    if ($updatequery_result) {
                        $_SESSION['status'] = "Contact Verified Successfully";
        ...
        elseif ($year == "Second Year" && $sem == "Second" && $course == "Bachelor of Arts in Religious Education") 
    {
        ...
        if ($fetch > 0) {
            ...
            foreach ($fetch as $key_child => $row) {
                ...
                $CSsubject = $row['code'];
                $ref_table = 'User/' . $key;
                $oneone = 'Subjects/ABREED/second_year/second_sem/' . $CSsubject . '/' . $key;
                $updatequery_result = $database->getReference($ref_table)->update($updateData);
                $addsub = $database->getReference($oneone)->update($studentData);
                    if ($updatequery_result) {
                        $_SESSION['status'] = "Contact Verified Successfully";
        ...
        elseif ($year == "Third Year" && $sem == "First" && $course == "Bachelor of Arts in Religious Education") 
    {
        ...
        if ($fetch > 0) {
            ...
            foreach ($fetch as $key_child => $row) {
                ...
                $CSsubject = $row['code'];
                $ref_table = 'User/' . $key;
                $oneone = 'Subjects/ABREED/third_year/first_sem/' . $CSsubject . '/' . $key;
                $updatequery_result = $database->getReference($ref_table)->update($updateData);
                $addsub = $database->getReference($oneone)->update($studentData);
                    if ($updatequery_result) {
                        $_SESSION['status'] = "Contact Verified Successfully";
        ...
        elseif ($year == "Third Year" && $sem == "Second" && $course == "Bachelor of Arts in Religious Education") 
        {
            ...
            if ($fetch > 0) {
                ...
                foreach ($fetch as $key_child => $row) {
                    ...
                    $CSsubject = $row['code'];
                    $ref_table = 'User/' . $key;
                    $oneone = 'Subjects/ABREED/third_year/second_sem/' . $CSsubject . '/' . $key;
                    $updatequery_result = $database->getReference($ref_table)->update($updateData);
                    $addsub = $database->getReference($oneone)->update($studentData);
                        if ($updatequery_result) {
                            $_SESSION['status'] = "Contact Verified Successfully";
            ...
            elseif ($year == "Fourth Year" && $sem == "First" && $course == "Bachelor of Arts in Religious Education") 
            {
                ...
                if ($fetch > 0) {
                    ...
                    foreach ($fetch as $key_child => $row) {
                        ...
                        $CSsubject = $row['code'];
                        $ref_table = 'User/' . $key;
                        $oneone = 'Subjects/ABREED/fourth_year/first_sem/' . $CSsubject . '/' . $key;
                        $updatequery_result = $database->getReference($ref_table)->update($updateData);
                        $addsub = $database->getReference($oneone)->update($studentData);
                            if ($updatequery_result) {
                                $_SESSION['status'] = "Contact Verified Successfully";
                ...
                elseif ($year == "Fourth Year" && $sem == "Second" && $course == "Bachelor of Arts in Religious Education") 
                {
                    ...
                    if ($fetch > 0) {
                        ...
                        foreach ($fetch as $key_child => $row) {
                            ...
                            $CSsubject = $row['code'];
                            $ref_table = 'User/' . $key;
                            $oneone = 'Subjects/ABREED/fourth_year/second_sem/' . $CSsubject . '/' . $key;
                            $updatequery_result = $database->getReference($ref_table)->update($updateData);
                            $addsub = $database->getReference($oneone)->update($studentData);
                                if ($updatequery_result) {
                                    $_SESSION['status'] = "Contact Verified Successfully";
    ...
    if ($fetch > 0) {
        ...
        foreach ($fetch as $key_child => $row) {
            ...
            $CSsubject = $row['code'];
            $ref_table = 'User/' . $key;
            $oneone = 'Subjects/BSED_E/first_year/first_sem/' . $CSsubject . '/' . $key;
            $updatequery_result = $database->getReference($ref_table)->update($updateData);
            $addsub = $database->getReference($oneone)->update($studentData);
                if ($updatequery_result) {
                    $_SESSION['status'] = "Contact Verified Successfully";
    ...
    elseif ($year == "First Year" && $sem == "Second" && $course == "Bachelor of Secondary Education, Major in English") 
    {
        ...
        if ($fetch > 0) {
            ...
            foreach ($fetch as $key_child => $row) {
                ...
                $CSsubject = $row['code'];
                $ref_table = 'User/' . $key;
                $oneone = 'Subjects/BSED_E/first_year/second_sem/' . $CSsubject . '/' . $key;
                $updatequery_result = $database->getReference($ref_table)->update($updateData);
                $addsub = $database->getReference($oneone)->update($studentData);
                    if ($updatequery_result) {
                        $_SESSION['status'] = "Contact Verified Successfully";
        ...
        elseif ($year == "Second Year" && $sem == "First" && $course == "Bachelor of Secondary Education, Major in English") 
    {
        ...
        if ($fetch > 0) {
            ...
            foreach ($fetch as $key_child => $row) {
                ...
                $CSsubject = $row['code'];
                $ref_table = 'User/' . $key;
                $oneone = 'Subjects/BSED_E/second_year/first_sem/' . $CSsubject . '/' . $key;
                $updatequery_result = $database->getReference($ref_table)->update($updateData);
                $addsub = $database->getReference($oneone)->update($studentData);
                    if ($updatequery_result) {
                        $_SESSION['status'] = "Contact Verified Successfully";
        ...
        elseif ($year == "Second Year" && $sem == "Second" && $course == "Bachelor of Secondary Education, Major in English") 
    {
        ...
        if ($fetch > 0) {
            ...
            foreach ($fetch as $key_child => $row) {
                ...
                $CSsubject = $row['code'];
                $ref_table = 'User/' . $key;
                $oneone = 'Subjects/BSED_E/second_year/second_sem/' . $CSsubject . '/' . $key;
                $updatequery_result = $database->getReference($ref_table)->update($updateData);
                $addsub = $database->getReference($oneone)->update($studentData);
                    if ($updatequery_result) {
                        $_SESSION['status'] = "Contact Verified Successfully";
        ...
        elseif ($year == "Third Year" && $sem == "First" && $course == "Bachelor of Secondary Education, Major in English") 
    {
        ...
        if ($fetch > 0) {
            ...
            foreach ($fetch as $key_child => $row) {
                ...
                $CSsubject = $row['code'];
                $ref_table = 'User/' . $key;
                $oneone = 'Subjects/BSED_E/third_year/first_sem/' . $CSsubject . '/' . $key;
                $updatequery_result = $database->getReference($ref_table)->update($updateData);
                $addsub = $database->getReference($oneone)->update($studentData);
                    if ($updatequery_result) {
                        $_SESSION['status'] = "Contact Verified Successfully";
        ...
        elseif ($year == "Third Year" && $sem == "Second" && $course == "Bachelor of Secondary Education, Major in English") 
        {
            ...
            if ($fetch > 0) {
                ...
                foreach ($fetch as $key_child => $row) {
                    ...
                    $CSsubject = $row['code'];
                    $ref_table = 'User/' . $key;
                    $oneone = 'Subjects/BSED_E/third_year/second_sem/' . $CSsubject . '/' . $key;
                    $updatequery_result = $database->getReference($ref_table)->update($updateData);
                    $addsub = $database->getReference($oneone)->update($studentData);
                        if ($updatequery_result) {
                            $_SESSION['status'] = "Contact Verified Successfully";
            ...
            elseif ($year == "Fourth Year" && $sem == "First" && $course == "Bachelor of Secondary Education, Major in English") 
            {
                ...
                if ($fetch > 0) {
                    ...
                    foreach ($fetch as $key_child => $row) {
                        ...
                        $CSsubject = $row['code'];
                        $ref_table = 'User/' . $key;
                        $oneone = 'Subjects/BSED_E/fourth_year/first_sem/' . $CSsubject . '/' . $key;
                        $updatequery_result = $database->getReference($ref_table)->update($updateData);
                        $addsub = $database->getReference($oneone)->update($studentData);
                            if ($updatequery_result) {
                                $_SESSION['status'] = "Contact Verified Successfully";
                ...
                elseif ($year == "Fourth Year" && $sem == "Second" && $course == "Bachelor of Secondary Education, Major in English") 
                {
                    ...
                    if ($fetch > 0) {
                        ...
                        foreach ($fetch as $key_child => $row) {
                            ...
                            $CSsubject = $row['code'];
                            $ref_table = 'User/' . $key;
                            $oneone = 'Subjects/BSED_E/fourth_year/second_sem/' . $CSsubject . '/' . $key;
                            $updatequery_result = $database->getReference($ref_table)->update($updateData);
                            $addsub = $database->getReference($oneone)->update($studentData);
                                if ($updatequery_result) {
                                    $_SESSION['status'] = "Contact Verified Successfully";
    ...
    if ($fetch > 0) {
        ...
        foreach ($fetch as $key_child => $row) {
            ...
            $CSsubject = $row['code'];
            $ref_table = 'User/' . $key;
            $oneone = 'Subjects/BSED_S/first_year/first_sem/' . $CSsubject . '/' . $key;
            $updatequery_result = $database->getReference($ref_table)->update($updateData);
            $addsub = $database->getReference($oneone)->update($studentData);
                if ($updatequery_result) {
                    $_SESSION['status'] = "Contact Verified Successfully";
    ...
    elseif ($year == "First Year" && $sem == "Second" && $course == "Bachelor of Secondary Education, Major in Science") 
    {
        ...
        if ($fetch > 0) {
            ...
            foreach ($fetch as $key_child => $row) {
                ...
                $CSsubject = $row['code'];
                $ref_table = 'User/' . $key;
                $oneone = 'Subjects/BSED_S/first_year/second_sem/' . $CSsubject . '/' . $key;
                $updatequery_result = $database->getReference($ref_table)->update($updateData);
                $addsub = $database->getReference($oneone)->update($studentData);
                    if ($updatequery_result) {
                        $_SESSION['status'] = "Contact Verified Successfully";
        ...
        elseif ($year == "Second Year" && $sem == "First" && $course == "Bachelor of Secondary Education, Major in Science") 
    {
        ...
        if ($fetch > 0) {
            ...
            foreach ($fetch as $key_child => $row) {
                ...
                $CSsubject = $row['code'];
                $ref_table = 'User/' . $key;
                $oneone = 'Subjects/BSED_S/second_year/first_sem/' . $CSsubject . '/' . $key;
                $updatequery_result = $database->getReference($ref_table)->update($updateData);
                $addsub = $database->getReference($oneone)->update($studentData);
                    if ($updatequery_result) {
                        $_SESSION['status'] = "Contact Verified Successfully";
        ...
        elseif ($year == "Second Year" && $sem == "Second" && $course == "Bachelor of Secondary Education, Major in Science") 
    {
        ...
        if ($fetch > 0) {
            ...
            foreach ($fetch as $key_child => $row) {
                ...
                $CSsubject = $row['code'];
                $ref_table = 'User/' . $key;
                $oneone = 'Subjects/BSED_S/second_year/second_sem/' . $CSsubject . '/' . $key;
                $updatequery_result = $database->getReference($ref_table)->update($updateData);
                $addsub = $database->getReference($oneone)->update($studentData);
                    if ($updatequery_result) {
                        $_SESSION['status'] = "Contact Verified Successfully";
        ...
        elseif ($year == "Third Year" && $sem == "First" && $course == "Bachelor of Secondary Education, Major in Science") 
    {
        ...
        if ($fetch > 0) {
            ...
            foreach ($fetch as $key_child => $row) {
                ...
                $CSsubject = $row['code'];
                $ref_table = 'User/' . $key;
                $oneone = 'Subjects/BSED_S/third_year/first_sem/' . $CSsubject . '/' . $key;
                $updatequery_result = $database->getReference($ref_table)->update($updateData);
                $addsub = $database->getReference($oneone)->update($studentData);
                    if ($updatequery_result) {
                        $_SESSION['status'] = "Contact Verified Successfully";
        ...
        elseif ($year == "Third Year" && $sem == "Second" && $course == "Bachelor of Secondary Education, Major in Science") 
        {
            ...
            if ($fetch > 0) {
                ...
                foreach ($fetch as $key_child => $row) {
                    ...
                    $CSsubject = $row['code'];
                    $ref_table = 'User/' . $key;
                    $oneone = 'Subjects/BSED_S/third_year/second_sem/' . $CSsubject . '/' . $key;
                    $updatequery_result = $database->getReference($ref_table)->update($updateData);
                    $addsub = $database->getReference($oneone)->update($studentData);
                        if ($updatequery_result) {
                            $_SESSION['status'] = "Contact Verified Successfully";
            ...
            elseif ($year == "Fourth Year" && $sem == "First" && $course == "Bachelor of Secondary Education, Major in Science") 
            {
                ...
                if ($fetch > 0) {
                    ...
                    foreach ($fetch as $key_child => $row) {
                        ...
                        $CSsubject = $row['code'];
                        $ref_table = 'User/' . $key;
                        $oneone = 'Subjects/BSED_S/fourth_year/first_sem/' . $CSsubject . '/' . $key;
                        $updatequery_result = $database->getReference($ref_table)->update($updateData);
                        $addsub = $database->getReference($oneone)->update($studentData);
                            if ($updatequery_result) {
                                $_SESSION['status'] = "Contact Verified Successfully";
                ...
                elseif ($year == "Fourth Year" && $sem == "Second" && $course == "Bachelor of Secondary Education, Major in Science") 
                {
                    ...
                    if ($fetch > 0) {
                        ...
                        foreach ($fetch as $key_child => $row) {
                            ...
                            $CSsubject = $row['code'];
                            $ref_table = 'User/' . $key;
                            $oneone = 'Subjects/BSED_S/fourth_year/second_sem/' . $CSsubject . '/' . $key;
                            $updatequery_result = $database->getReference($ref_table)->update($updateData);
                            $addsub = $database->getReference($oneone)->update($studentData);
                                if ($updatequery_result) {
                                    $_SESSION['status'] = "Contact Verified Successfully";
