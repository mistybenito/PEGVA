<?php
    include("auth/ch-ed_eng_auth.php");
    include("nav-new.php");
?>
<!DOCTYPE html>
<html>
    <head>
        <title>BSED-Eng Student List</title>
        <meta charset="UTF-8">
    ...
    <body>
    <div id="student-list">
        <p class="course-student-list">BSED-Eng Student List</p>
        ...
        <div class="input-group mb-3">
            ...
            <tr>
                <?php
                    if ($row['Course'] == "Bachelor in Secondary Education Major in English")
                     {
                        ?>
